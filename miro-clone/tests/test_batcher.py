...
async def test_batch_updates(setup_db_sync):
    ...
    await db_batcher.push(
        "modify",
        {"board_id": "default", "id": "test_shape_1", "left": 50, "fill": "blue"},
    )
    ...
    # Push remove
    await db_batcher.push("remove", {"board_id": "default", "id": "test_shape_1"})
...
async def test_batch_merge(setup_db_sync):
    ...
    await db_batcher.push(
        "modify",
        {"board_id": "default", "id": "test_shape_2", "left": 50, "fill": "blue"},
    )
...
async def test_batch_merge_conditions(setup_db_sync):
    ...
    await db_batcher.push(
        "modify", {"board_id": "default", "id": "test_shape_3", "left": 10}
    )
    await db_batcher.push(
        "modify", {"board_id": "default", "id": "test_shape_3", "top": 20}
    )

    # Test remove then add/modify
    await db_batcher.push("remove", {"board_id": "default", "id": "test_shape_4"})
    await db_batcher.push(
        "add", {"board_id": "default", "id": "test_shape_4", "type": "rect"}
    )

    # Test remove then something else
    await db_batcher.push(
        "add", {"board_id": "default", "id": "test_shape_5", "type": "rect"}
    )
...
async def test_batch_merge_unhandled_action():
    ...
    await db_batcher.push(
        "add", {"board_id": "default", "id": "test_shape_10", "type": "rect"}
    )
    await db_batcher.push(
        "some_unknown_action", {"board_id": "default", "id": "test_shape_10"}
    )
    await db_batcher.process_batch()
